...
const { ColorReducer } = require('./src/colorreductionmanagement');
const { FacetCreator } = require('./src/facetCreator');
const { FacetReducer } = require('./src/facetReducer');
const { FacetResult } = require('./src/facetmanagement');
const { FacetBorderTracer } = require('./src/facetBorderTracer');
const { FacetBorderSegmenter } = require('./src/facetBorderSegmenter');
const { FacetLabelPlacer } = require('./src/facetLabelPlacer');
const { Point } = require('./src/structs/point');
...
app.post('/process', upload.single('image'), async (req, res) => {
  try {
    ...
    const palette = colormapResult.colorsByIndex.map((color, index) => ({
      number: index,
...
function createSVG(facetResult, colorsByIndex, sizeMultiplier, fill, stroke, addColorLabels, fontSize, fontColor) {
  let svgString = '';
